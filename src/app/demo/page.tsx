...
const mockProducts: any[] = [
    {
        ...
        description: 'Conforto absoluto com espuma D33 e estrutura em madeira maciça.',
        price: 1890.00,
        rating: 4.8,
        reviews_count: 124,
        ...
        is_verified: true,
        partners: mockPartners.amazon,
        created_at: '', category_id: null, partner_id: 'p1'
    },
    {
        id: 'prod2',
        name: 'Poltrona Decorativa Opala',
        description: 'Design clássico que combina com qualquer ambiente.',
        price: 450.00,
        rating: 4.2,
        reviews_count: 45,
        ...
        is_verified: false,
        partners: mockPartners.magalu,
        created_at: '', category_id: null, partner_id: 'p2'
    },
    {
        id: 'prod3',
        name: 'Mesa de Jantar Industrial',
        description: 'Estilo loft novaiorquino com tampo de madeira rústica.',
        price: 1200.00,
        rating: 4.9,
        reviews_count: 89,
    ...
    return (
        <div className="bg-cream min-h-screen">
            ...
            <div className="max-w-4xl mx-auto pt-32 pb-20 px-6">
                ...
                <p className="mb-12 text-[#666]">Demonstração dos novos blocos de produto da FaceStore.</p>
